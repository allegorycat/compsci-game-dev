...
smallest_font = pygame.font.SysFont('Helvetica', 26)
...
class Label:
    ...
    def set(self, text):
        self.text = small_font.render(text, 1, pygame.Color("Blue"))
...
text_surface_title = big_font.render("TITLE OF THE GAME", True, 'Blue')
text_surface_by = smallest_font.render('By Yan', True, 'Blue')
